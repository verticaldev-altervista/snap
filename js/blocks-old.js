...
SymbolMorph.prototype.drawSymbolWorld = function (canvas, color) {
    // answer a canvas showing a solid circle
    var ctx = canvas.getContext('2d'),
        w = canvas.width,
        r=w-(w/2);
    ...
    ctx.strokeStyle = color.toString();
    ctx.arc(w / 2, w / 2, r , radians(0), radians(360), false);
    ctx.stroke();
    
    ctx.strokeStyle = color.toString();
    ctx.arc(w / 4, h / 2, r , radians(290), radians(70), false);
    ctx.stroke();

    ctx.strokeStyle = color.toString();
    ctx.arc(w-(w / 4), h / 2, r , radians(110), radians(250), false);
    ctx.stroke();
